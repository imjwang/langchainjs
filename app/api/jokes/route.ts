...
A: <flop>{flop}</flop>
  ...
  const jokeFewShotPromptTemplate = PromptTemplate.fromTemplate(jokeFewShotTemplate)
  const flopFewShotPromptTemplate = PromptTemplate.fromTemplate(flopFewShotTemplate)
  ...
  const jokePromptTemplate = new PipelinePromptTemplate({
    pipelinePrompts: [
      {
        name: "system",
        prompt: PromptTemplate.fromTemplate("You are a joke telling AI. You are paid to good jokes and make people laugh.")
      },
      {
        name: "jokes",
        // @ts-ignore
...
`)
      ...
      {
        name: "flops",
        prompt: PromptTemplate.fromTemplate(`When you reply, use the examples of good jokes and flops to understand the user's sense of humor. Remember that flops are bad jokes. \
